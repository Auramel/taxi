...
class StartScreen extends Screen
{
    ...
    {
        $text = 'Для работы с ботом зарегистрируйтесь в парке, Если же вы уже зарегистрированы в парке, то выполните вход по ВУ. После регистрации необходимо выполнить вход по ВУ';
        $buttons = [
            [
                [
